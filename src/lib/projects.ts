...
const fallbackProjects: Project[] = [
  {
    ...
    technologies: ["Next.js", "Tailwind CSS v4", "PostgreSQL"],
    collaborators: ["Grem", "RJ"],
    roles: { Grem: "Database Architecture", RJ: "UI/UX Layouts" },
  ...
  },
  {
    ...
    technologies: ["React", "Vite 6", "Firebase", "Tailwind CSS v4"],
    collaborators: ["Grem", "RJ"],
    roles: { Grem: "Lead Developer", RJ: "Game Design & Narrative" },
    status: "Prototype",
    version: "v4.0.0",
